class StreetAddress
  ...
  def save
    ...
    Address.create!(postal_code: postal_code,shipping_area: shipping_area, city: city, address_detail: address_detail,apartment_name: apartment_name, phone_number: phone_number,order_id: order.id)
  end
end